...
var supportedPatches = map[string]Patches{
	"AMD64": Patches{
		VersionPatches: []VersionPatch{
			...
			{GoVersion: "1.26",
				OldBytes: []byte{0x41, 0x80, 0xBA, 0xA0, 0x00, 0x00, 0x00, 0x00, 0x0F, 0x85, 0x7F, 0x01, 0x00, 0x00},
				NewBytes: []byte{0x41, 0x80, 0xBA, 0xA0, 0x00, 0x00, 0x00, 0x00, 0x0F, 0x84, 0x7F, 0x01, 0x00, 0x00},
			},
		},
	},
	"ARM64": Patches{
		VersionPatches: []VersionPatch{
			...
			{GoVersion: "1.26",
				OldBytes: []byte{0x0A, 0x81, 0x42, 0x39, 0x2A, 0x08, 0x00, 0x37, 0x01, 0x09, 0x40, 0xF9, 0x61, 0x00, 0x00, 0xB5},
				NewBytes: []byte{0x0A, 0x81, 0x42, 0x39, 0x2A, 0x08, 0x00, 0x36, 0x01, 0x09, 0x40, 0xF9, 0x61, 0x00, 0x00, 0xB5},
			},
		},
	},
}
