...
var supportedPatches = map[string]Patches{
	"AMD64": Patches{
		VersionPatches: []VersionPatch{
			...
			{GoVersion: "1.27",
				OldBytes: []byte{0x41, 0x80, 0xBA, 0xA0, 0x00, 0x00, 0x00, 0x00, 0x0F, 0x1F, 0x44, 0x00, 0x00, 0x0F, 0x85, 0x81, 0x01, 0x00, 0x00},
				NewBytes: []byte{0x41, 0x80, 0xBA, 0xA0, 0x00, 0x00, 0x00, 0x00, 0x0F, 0x1F, 0x44, 0x00, 0x00, 0x0F, 0x84, 0x81, 0x01, 0x00, 0x00},
			},
		},
	},
	"ARM64": Patches{
		VersionPatches: []VersionPatch{
			...
			{GoVersion: "1.27",
				OldBytes: []byte{0x0A, 0x81, 0x42, 0x39, 0xA, 0x08, 0x00, 0x37, 0x1A, 0x09, 0x40, 0xF9, 0x7A, 0x00, 0x00, 0xB5},
				NewBytes: []byte{0x0A, 0x81, 0x42, 0x39, 0xA, 0x08, 0x00, 0x36, 0x1A, 0x09, 0x40, 0xF9, 0x7A, 0x00, 0x00, 0xB5},
			},
		},
	},
}
