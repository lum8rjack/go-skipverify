...
var supportedPatches = map[string]Patches{
	"AMD64": Patches{
		VersionPatches: []VersionPatch{
			...
			{GoVersion: "1.23",
				OldBytes: []byte{0x00, 0x00, 0x0F, 0x85, 0x7E, 0x01, 0x00, 0x00},
				NewBytes: []byte{0x00, 0x00, 0x0F, 0x84, 0x7E, 0x01, 0x00, 0x00},
			},
			{GoVersion: "1.24",
				OldBytes: []byte{0x00, 0x00, 0x0F, 0x85, 0x7E, 0x01, 0x00, 0x00},
				NewBytes: []byte{0x00, 0x00, 0x0F, 0x84, 0x7E, 0x01, 0x00, 0x00},
	...
	"ARM64": Patches{
		VersionPatches: []VersionPatch{
			{GoVersion: "1.23",
				OldBytes: []byte{0x0A, 0x81, 0x42, 0x39, 0x6A, 0x08, 0x00, 0x37},
				NewBytes: []byte{0x0A, 0x81, 0x42, 0x39, 0x6A, 0x08, 0x00, 0x36},
			},
			{GoVersion: "1.24",
				OldBytes: []byte{0x0A, 0x81, 0x42, 0x39, 0x6A, 0x08, 0x00, 0x37},
				NewBytes: []byte{0x0A, 0x81, 0x42, 0x39, 0x6A, 0x08, 0x00, 0x36},
